    ...
    return Scaffold(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 30),
              _buildTextField(
                  '비밀번호 확인', '비밀번호를 확인해 주세요.', _confirmPasswordController,
                  obscureText: true),
              const SizedBox(height: 30),
              const Text('보호자 연락처',
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          onPressed: _register,
          style: ButtonStyle(
            backgroundColor: WidgetStateProperty.all(const Color(0xFF549DEF)),
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(15.0),
                borderSide:
                    const BorderSide(color: Color(0xFF549DEF), width: 2.0),
              ),
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(15.0),
                borderSide:
                  ...
                  ? Padding(
                      ...
                      child: TextButton(
                        ...
                        style: ButtonStyle(
                          ...
                          minimumSize:
                              WidgetStateProperty.all(const Size(60, 30)),
                          shape: WidgetStateProperty.all(
                            RoundedRectangleBorder(
